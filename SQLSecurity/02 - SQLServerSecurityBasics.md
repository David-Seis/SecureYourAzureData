...
You have various options for creating a secure database program. Using Always Encrypted, you can ensure data is never decrypted by the database and is only seen decrypted on the application user side. This helps with the separation of duties, and you can read more about it <a href="https://learn.microsoft.com/en-us/sql/relational-databases/security/encryption/always-encrypted-database-engine?view=sql-server-ver16">here.</a>
