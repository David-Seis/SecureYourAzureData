...
<h4><img style="float: left; margin: 0px 15px 15px 0px;" src="../graphics/point1.png"><b>Activity: Apply Permissions to Azure SQL Database Objects</b></h4>
<br>
...
Views allow you to show only the columns and rows required for least-privilege, and Functions and Stored Procedures allow you to restrict both columns and rows. 
