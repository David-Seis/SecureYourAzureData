...
<table style="tr:nth-child(even) {background-color: #f2f2f2;}; text-align: left; display: table; border-collapse: collapse; border-spacing: 5px; border-color: gray;">
  ...
  <tr><td><a href="https://github.com/David-Seis/SecureYourAzureData/blob/main/SQLSecurity/02%20-%20SQLServerSecurityBasics.md" target="_blank">02 - SQL Server Security</a></td>
      <td> Details the primary components and tools for on-premises/Virtual Machione SQL Server security environments, from Principals and Securables to Data Control Language (DDL) statements.</td></tr>
